...
from teacherhire.views import home, dashboard, manage_teacher, manage_subject,manage_qualification, manage_rating,delete_rating,delete_teacher,delete_quali,delete_subject
